...
function DefaultBanner({onClick}) {
  return (
    <div className="w-full p-8 bg-white rounded-lg shadow-md py-16">
      <div className="flex flex-col items-center gap-4">
        ...
        <button onClick={onClick}  className="mb-2 px-8 py-2 border  border-purple-600 text-purple-600 hover:text-white rounded-2xl hover:bg-purple-700">
          Select File
        </button>
      </div>
    </div>
